...
### Settings UI
- **SettingsForm.cs** — hosts the system tray icon with a context menu. Contains sliders/pickers for grid and magnification settings, bound directly to the `Lens` singleton via WinForms data binding. Closing the window hides it (close-to-tray) unless explicitly exiting.
...
- The project targets .NET 10 / `net10.0-windows`.
